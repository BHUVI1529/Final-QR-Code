...
const Success = () => {
    ...
    // Automatically navigate to User Dashboard after 5 seconds
    useEffect(() => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-green-100 via-teal-50 to-gray-50 flex flex-col items-center justify-between">
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg max-w-md text-center mt-10"> {/* Adjusted mt-10 */}
                <h2 className="text-2xl font-semibold text-teal-700 mb-4">Logout marked Successfully!</h2>
                <p className="text-gray-700 mb-6">Redirecting to User Dashboard...</p>
                <button
