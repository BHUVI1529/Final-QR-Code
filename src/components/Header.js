...
function Header() {
  ...
  return (
    <div className="bg-gray-800 text-white p-2 flex items-center justify-between relative z-50"> {/* Reduced padding */}
      {/* Logo Section */}
      <div className="flex items-center p-1"> {/* Reduced padding around logo */}
        <img
          src={logo}
